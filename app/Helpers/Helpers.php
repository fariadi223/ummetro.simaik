...
class Helpers
{
  ...
  public static function appProdi()
  {
    if(!session('session_id_sms'))
      return ['id_sms' => '', 'nm_lemb' => '', 'jenjang_didik' => ''];

    $prodi = TblSmsModel::find(session('session_id_sms'));
    return [
      'id_sms' => $prodi['id_sms'],
      'nm_lemb' => $prodi['nm_lemb'],
      'jenjang_didik' => $prodi['jenjang_didik']
    ];
  }
}
