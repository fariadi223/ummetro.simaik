...
<h3>
  Users
  <small class="text-muted">Halaman informasi users</small>
</h3>
<div class="row">
  <div class="col-md-12">
    <div class="card mt-3">
      <div class="card-datatable table-responsive text-nowrap">
        <table class="dt-table-users table">
...
@include('_partials/_users/users-modal-roles')
@include('_partials/_users/users-modal-loginas')
@include('_partials/_mentor/modal-mentro-add')
@endsection
