...
@section('page-script')
<script src="{{asset('assets/js/authentication/pages-register-sdm.js')}}"></script>
@endsection
        ...
        @if(!$registered)
          <div id="multiStepsValidation" class="bs-stepper shadow-none">
            <div class="bs-stepper-header border-bottom-0">
              <div class="step" data-target="#ssoValidation">
                <button type="button" class="step-trigger">
                  <span class="bs-stepper-circle"><i class="ti ti-smart-home ti-sm"></i></span>
                  <span class="bs-stepper-label">
                    <span class="bs-stepper-title">Akun SSO</span>
                    <span class="bs-stepper-subtitle">Konfirmasi</span>
                  </span>
                </button>
              </div>
              <div class="line">
            ...
            <div class="bs-stepper-content">
              <form id="formRegister" onSubmit="return false">
                <!-- Account Details -->
                <div id="ssoValidation" class="content form-block">
                  <div class="content-header mb-4">
                    <h3 class="mb-1">Konfirmasi</h3>
                    <p>Masukan akun Sistem Informasi Kepegawaian (SIMPEG) Universitas Muhammadiyah Metro!.</p>
                  </div>
                  <div class="row g-3">
                    <div class="col-sm-6">
                      <label class="form-label" for="username_sso">Usernames SIMPEG</label>
                      <input type="text" name="username_sso" id="username_sso" class="form-control" placeholder="" />
                    </div>
                    <div class="col-sm-6 form-password-toggle">
                      <label class="form-label" for="password_sso">Password SIMPEG</label>
                      <div class="input-group input-group-merge">
                        <input type="password" id="password_sso" name="password_sso" class="form-control" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="multiStepsPass2" />
                        <span class="input-group-text cursor-pointer" id="password_sso2"><i class="ti ti-eye-off"></i></span>
                      </div>
                    </div>
                    <div class="col-12 d-flex justify-content-between mt-4">
                      ...
                      <button class="btn btn-primary btn-next btn-form-block-overlay"> <span class="align-middle d-sm-inline-block d-none me-sm-1 me-0">Konfirmasi</span> <i class="ti ti-arrow-right ti-xs"></i></button>
                    </div>
                  </div>
                </div>
                <!-- Account Details -->
                <div id="accountDetailsValidation" class="content">
                  ...
                  <div class="row g-3">
                    ...
                    <input type="hidden" id="nbm" name="nbm" value="">
                    <input type="hidden" id="sdm" name="pegawai_id" value="">
                    ...
                    <div class="col-12 mb-0">
                      <table class="table table-borderless">
                        <tbody>
                          ...
                          <!--
                          <tr>
                            <td class="col-lg-3 ps-0 align-top text-nowrap py-1">Program Studi</td>
                            <td class="col-lg-9 px-0 py-1"><span class="fw-semibold lbl-prodi-nama">...</span></td>
                          </tr>
                          !-->
                          <tr>
                            <td class="col-lg-3 ps-0 align-top text-nowrap py-1">N B M</td>
                            <td class="col-lg-9 px-0 py-1"><span class="fw-semibold lbl-nbm">...</span></td>
                          </tr>
                          <tr>
