  ...
  <div class="authentication-inner row">
    ...
    <div class="d-none d-lg-flex col-lg-7 p-0">
      <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
        <img src="{{ asset('assets/img/illustrations/boy-with-laptop-'.$configData['style'].'.png') }}" alt="auth-login-cover" class="img-fluid my-5 auth-illustration" data-app-light-img="illustrations/boy-with-laptop-light.png" data-app-dark-img="illustrations/boy-with-laptop-dark.png">
    ...
    <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
      <div class="w-px-400 mx-auto">
        ...
        <p class="mt-4">Login Menggunakan Email/NPM dan Password</p>
        ...
        <div class="alert alert-danger alert-dismissible d-flex align-items-baseline" role="alert">
          ...
          <div class="d-flex flex-column ps-1">
            ...
            <p class="mb-0">Email dan Password tidak Terdaftar!.</p>
        ...
        <div class="btn-group me-3 btn-block w-100">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <li><a class="dropdown-item" href="{{url('auth/mahasiswa/register')}}">Pendafatran Akun Mahasiswa UM Metro</a></li>
            <li><a class="dropdown-item" href="{{url('auth/register')}}">Pendaftaran Akun Mitra Binaan</a></li>
            <li><a class="dropdown-item" href="{{url('auth/register?role=sdm')}}">Pendaftaran Akun SDM</a></li>
          </ul>
        </div>
