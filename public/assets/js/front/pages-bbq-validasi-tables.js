...
$(function () {
  ...
  var dtBbqValidasi = $('.dt-table-bbq-validasi');

  if (dtBbqValidasi.length) {
    var bbqTableValidasi = dtBbqValidasi.DataTable({
      processing: true,
      serverSide: true,
      ajax: {
        ...
        },
        {
            ...
            render: function (data, type, full, meta) {
              ...
              var $row_output =
                '<div class="d-flex justify-content-start align-items-center">' +
                '<div class="d-flex flex-column">' +
                ' ' + full.mentor_validasi.toUpperCase() +
                '<small class="text-truncate text-muted">  Mentor. ' + mentor.name.toUpperCase() + '</small>' +
                '</div>' +
                '</div>';
              return $row_output;
            }
