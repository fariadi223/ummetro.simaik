...
/***/ "./resources/assets/vendor/js/moment.min.js":
/*!**************************************************!*\
  !*** ./resources/assets/vendor/js/moment.min.js ***!
  \**************************************************/
...
!function (e, t) {
  ...
  function dt(t) {
    var e;
    if (void 0 === R[t] && "undefined" != "object" && module && module.exports && null != t.match("^[^/\\\\]*$")) try {
      e = at._abbr, Object(function webpackMissingModule() { var e = new Error("Cannot find module 'undefined'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), ct(e);
    } catch (e) {
      R[t] = null;
    }
    return R[t];
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/vendor/js/moment.min.js");
/******/ 	
